...
const TourCard: React.FC<Tour> = ({ slug, tourName, tourOverview,country, cost, thumbnail}) => {
  ...
  return (
    <Card className="w-full rounded-sm">
      ...
      <CardBody className="pb-4">
        <h3 className={`text-xl  mb-2 ${antic.className} text-primary`}>{tourName}</h3>
        <span className='text-gray-600 text-xs'>{tourOverview.slice(0,100)}...</span>
      </CardBody>
