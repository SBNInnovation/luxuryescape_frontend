        ...
        <>
            <div className='relative w-full h-auto flex items-center justify-center'>
                ...
                <div className='absolute flex top-[25%] lg:justify-center justify-start lg:px-0 px-4 flex-col z-[100] lg:items-center items-start'>
                    <h1 className={`${antic.className} lg:text-6xl text-2xl font-bold text-white }`}>Welcome to </h1>
                    <h1 className={`${antic.className} lg:text-7xl text-2xl font-bold text-primary }`}>Luxury Escapes Nepal</h1>
