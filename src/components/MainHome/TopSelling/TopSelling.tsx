...
const TopSellingSlider = () => {
  ...
  return (
    <div
      className="my-16 lg:px-16 px-4 w-full relative"
      onMouseEnter={() => setIsPaused(true)}
      onMouseLeave={() => setIsPaused(false)}
    >
      <SharedTitle
        title="Explore our top selling packages"
        ...
        >
          ...
          >
            ...
            <div className="lg:w-2/5 w-full flex flex-col justify-center lg:px-8 px-0 mt-4 lg:mt-0">
              ...
              <Link
                href={`/destinations/${currentTour?.country?.toLowerCase()}/${currentTour?.slug || currentTour?._id}`}
              >
                <Button className="rounded-sm px-12 bg-primary text-white mt-4 lg:mt-12 w-fit">
                  View Package
                </Button>
              </Link>
            </div>
              ...
              >
                <Image
                  ...
                  style={{
                    ...
                    width: '230px', // Fixed width for all
                  }}
                />
                <motion.div
                ...
                >
                  <h1 className="line-clamp-1">{item?.tourName}</h1>
                </motion.div>
              </motion.div>
            </motion.div>
          ))}
