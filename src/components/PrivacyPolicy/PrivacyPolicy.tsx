  ...
  return (
    <div>
      <div className="lg:px-24 px-4">
        <h2 className="text-3xl font-bold mb-4 mt-8">Privacy Policy</h2>
        <p className="text-justify my-8">
          This Privacy Policy governs the manner in which Nepal Luxury Escapes
          Pvt. Ltd. collects, uses, maintains and discloses information
          collected from users (each, a &quot;User&quot;) of the
          https://www.nepalluxuryescapes.com website (&quot;Site&quot;). This
          privacy policy applies to the Site and all products and services
          offered by Nepal Luxury Escapes Pvt. Ltd.
        </p>
        <h1 className="font-bold text-xl mt-12 mb-8">
        ...
        <h2 className="font-bold text-xl mt-12 mb-8">
          Non-personal identification information
        </h2>
        <p className="text-justify my-4">
          We may collect non-personal identification information about Users
          whenever they interact with our Site. The non-personal identification
        ...
        <h3 className="font-bold text-xl mt-12 mb-8">Web browser cookies</h3>
        <p className="text-justify my-4">
          ...
          The user may choose to set their web browser to refuse cookies or to
          alert you when cookies are being sent. If they do so, note that some
          parts of the Site may not function properly.
        </p>
        <h4 className="font-bold text-xl mt-12 mb-8">
          How we use collected information
        </h4>
        <p>
          Nepal Luxury Escapes Pvt Ltd. may collect and use Users personal
          information for the following purposes: <br />
          <br />- To improve customer service nformation you provide helps us
          ...
          from receiving future emails, they may do so by contacting us via our
          Site.
          <br />
          <br />
        </p>
        <h5 className="font-bold text-xl mt-12 mb-8">
        ...
        <h6 className="font-bold text-xl mt-12 mb-8">
        ...
        <p className="text-justify my-4">
          Nepal Luxury Escapes Pvt Ltd has the discretion to update this privacy
        ...
        <h5 className="font-bold text-xl mt-12 mb-8">Contacting us</h5>
        <p className="text-justify my-4">
